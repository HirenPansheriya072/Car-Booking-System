    ...
    <nav>
        ...
        <div class=" registration popup">
           <form action="user_login_database.php" method="POST">
                    ...
                    <div class="form">
                        <h3 style="font-family: 'poppins',sans-serif";>Registration</h3>

                        <input type="text" name='fname' placeholder="First Name" required><br><br>
                        <input type="text" name='lname' placeholder="Last Name" required><br><br>
                        <input type="email" name='email' placeholder="Email" required><br><br>
                        <input type="text" name='address' placeholder="Address" required><br><br>
                        <input type="tel" name='phone' placeholder="Phone no." maxlength=10 required><br><br>
                        ...
                        <!-- <button type="submit"  name="submit" value="Delete">Delete</button>    FOR DELETE                -->
                     </div>
            </form>
        </div>
    </body>

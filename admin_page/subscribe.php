        ...
        <div class="container-fluid px-4">
            <h1 class="mt-4"></h1>
                <ol class="breadcrumb mb-4">
                   <li class="breadcrumb-item" style="margin-top: 65px;"><h4>Subscribe</h4></li>
                </ol>
                                                    ...
                                                    foreach($query_run as $row)
                                                        {
                                                            ?>
                                                                <tr>
                                                                    <td><?= $row['semail']; ?></td>                                                                   
                                                                    <td style="text-align: center;"><button class="btn btn-danger"><a style="color: white;" href="admin_page_delete/sub_delete.php?delete=<?php echo $row['semail']; ?>">Delete</a></button></td>                                       
                                                                </tr>
                                                            <?php
                                                        }
                                                }
